...
short ADXL345_Init(void)
{
  ...
  {   
    struct Init_Data Acce_Init_Data[]={{POWER_CTL,0x20},{INT_ENABLE,0x00},{THRESH_TAP,0x16},{OFSX,0x00},{OFSY,0x00},{OFSZ,0x00},
                                       {DUR,0x25},{Latent,0x78},{Window,0xff},{THRESH_ACT,thres_acc_min},{THRESH_INACT,thres_acc_min},
                                       {TIME_INACT,0x05},{ACT_INACT_CTL,0xff},{THRESH_FF,0x08},{TIME_FF,0x28},{TAP_AXES,0x07},{BW_RATE,0x0a},
                                       {INT_MAP,0x87},{DATA_FORMAT,0x2b},{FIFO_CTL,0xa8}};
