...
#define SET_GREEN_LED_ON()      MAP_GPIOPinWrite(GPIOA0_BASE,GPIO_PIN_0,GPIO_PIN_0);    //SET GREEN LED ON//
#define SET_GREEN_LED_OFF()     MAP_GPIOPinWrite(GPIOA0_BASE,GPIO_PIN_0,0x00);          //SET GREEN LED OFF//

#define SET_RED_LED_ON()        MAP_GPIOPinWrite(GPIOA3_BASE,GPIO_PIN_6,GPIO_PIN_6);    //SET RED LED ON//
#define SET_RED_LED_OFF()       MAP_GPIOPinWrite(GPIOA3_BASE,GPIO_PIN_6,0x00);          //SET RED LED OFF//

#define SET_BELL_ON()           MAP_GPIOPinWrite(GPIOA1_BASE,GPIO_PIN_0,GPIO_PIN_0);    //SET BELL ON//
#define SET_BELL_OFF()          MAP_GPIOPinWrite(GPIOA1_BASE,GPIO_PIN_0,0x00);          //SET BELL OFF//
